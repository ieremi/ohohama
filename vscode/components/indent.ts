...
export const indentColors = {
	"editorIndentGuide.activeBackground": semantic.order[0], // Color of the active editor indentation guide.
	...
	"editorIndentGuide.background": semantic.order[0], // Color of the editor indentation guides.
