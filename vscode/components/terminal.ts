...
export const terminalColors = {
    ...
    "terminal.ansiBlack": semantic.ansi.normal.black,
    "terminal.ansiWhite": semantic.ansi.normal.white,
    "terminal.ansiBlue": semantic.ansi.normal.blue,
    "terminal.ansiCyan": semantic.ansi.normal.cyan,
    "terminal.ansiGreen": semantic.ansi.normal.green,
    "terminal.ansiMagenta": semantic.ansi.normal.magenta,
    "terminal.ansiRed": semantic.ansi.normal.red,
    "terminal.ansiYellow": semantic.ansi.normal.yellow,
    "terminal.ansiBrightBlack": semantic.ansi.bright.black,
    "terminal.ansiBrightWhite": semantic.ansi.bright.white,
    "terminal.ansiBrightBlue": semantic.ansi.bright.blue,
    "terminal.ansiBrightCyan": semantic.ansi.bright.cyan,
    "terminal.ansiBrightGreen": semantic.ansi.bright.green,
    "terminal.ansiBrightMagenta": semantic.ansi.bright.magenta,
    "terminal.ansiBrightRed": semantic.ansi.bright.red,
    "terminal.ansiBrightYellow": semantic.ansi.bright.yellow,
