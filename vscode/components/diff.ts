...
export const diffColors = {
    ...
    "diffEditor.diagonalFill": semantic.inactive,
    ...
    "diffEditor.removedLineBackground": semantic.deletedTransparent,
    "diffEditor.removedTextBackground": semantic.deletedTransparent,
