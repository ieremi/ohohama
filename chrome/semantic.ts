...
export const semantic = {
    ...
    background: hexFromArgb(palette.neutral.tone(40)),
    bookmark_text: palette.white,
    border: palette.zero,
    button: hexFromArgb(palette.neutral.tone(60)),
    ...
    omnibox: hexFromArgb(palette.secondary.tone(20)),
    popup: palette.black,
    result: palette.white,
    selected: palette.city.t,
    tab: hexFromArgb(palette.primary.tone(50)),
    text: palette.white,
    toolbar: hexFromArgb(palette.neutral.tone(50)),
    url: palette.city.k,
    zero: palette.zero,
} as const;
